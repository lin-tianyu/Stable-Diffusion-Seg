...
class KSEGBase(Dataset):
    ...
    def __init__(self, data_root, size=256, interpolation="nearest", mode=None, num_classes=2):
        ...
        print(f"[Dataset]: KSEG with 2 classes, in {self.mode} mode")
    ...
    def _parse_data_list(self): # 80% / 10% / 10%
        ...
        train_imgs, val_imgs, test_imgs = all_imgs[:800], all_imgs[800:800+100], all_imgs[800+100:]
...
class KSEGTrain(KSEGBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="data/Kvasir-SEG/images", mode="train", **kwargs)


class KSEGValidation(KSEGBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="data/Kvasir-SEG/images", mode="val", **kwargs)


class KSEGTest(KSEGBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="data/Kvasir-SEG/images", mode="test", **kwargs)
