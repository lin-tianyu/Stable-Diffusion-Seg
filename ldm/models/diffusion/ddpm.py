...
class LatentDiffusion(DDPM):
    ...
    def get_loss_seg_regression2(self, x_start, x_noisy, t, model_output, seg_label):
        ...
        mask = F.interpolate(mask, size=(x_noisy.shape[2], x_noisy.shape[3]), mode='nearest')   # image space size -> latent space size
        ...
        seg_loss_front = self.get_loss(x_recon * mask,      x_start * mask,     mean=False)  # loss type according to `self.loss_type`
