...
- 11/01: Re-implement SDSeg in OOP! Check [here](#dataset-related) for more! 
...
```bash
nohup python -u main.py --base configs/SDSeg/cvc-ldm-kl-8.yaml -t --gpus 0, --name experiment_name > nohup/experiment_name.log 2>&1 &
```
